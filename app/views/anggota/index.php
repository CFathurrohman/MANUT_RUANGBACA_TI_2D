...
<!--                            <td>-->
<!--                                <a href="--><?php //= BASEURL; ?><!--/anggota/hapus/--><?php //= $anggota['id']; ?><!--" class="badge btn btn-danger float-right" onclick="return confirm('Konfirmasi');">hapus</a>-->
<!--                            </td>-->
<!--                        </tr>-->
<!--                    --><?php //endforeach; ?>
<!--                </tbody>-->
...
<!--                    <form action="--><?php //= BASEURL; ?><!--/anggota/tambah" method="post">-->
<!--                        <div class="mb-3">-->
