                ...
                <tbody>
                    ...
                    <?php foreach ($data['anggota'] as $anggota) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASEURL; ?>/anggota/ubah/<?= $anggota['id']; ?>" class="badge btn btn-success float-right tampilModalUbah" data-bs-toggle="modal" data-bs-target="#tambahModal" data-id="<?= $anggota['id']?>">Edit</a>
