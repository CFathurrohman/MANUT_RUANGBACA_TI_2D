        ...
        <div class="card mb-3">
            ...
            <?php foreach ( $data['buku'] as $book): ?>
                <div class="row g-0">
                    ...
                    <td><img src="<?= BASEURL; ?>/img/<?= $book['gambar']; ?>" class="card-img-top" alt="" style="width: 195px; height: 300px"></td>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><small class="text-muted"><strong>Deskripsi</strong>
                                :&nbsp; <br> <?= $book['deskripsi']; ?></small></li>
                        </ul>
                    </div>
                </div>
            <?php endforeach; ?>
